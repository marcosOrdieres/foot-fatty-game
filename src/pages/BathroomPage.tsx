...
const BathroomPage = () => {
  ...
  const sponges = [
    fatImages.spongeNormal,
    fatImages.spongeNormal,
    fatImages.spongeNormal,
    fatImages.spongeOrange,
    fatImages.spongeFire,
  ];
  ...
  const correlacionDeTres = async () => {
    ...
    if ((currentGamesWonWithThisOne + 1) % 5 === 0) {
      // for the correlation of 4, so 5n - 1
    ...
    <ImageBackground
      ...
      <View
        ...
        <View
          ...
          <LeftFoot
            onSwipeLeft={() =>
              startGame && !correlacionTresForGame
                ? onSwipeLeftFootToLeft()
                : startGame && correlacionTresForGame && leftGame
                ? onSwipeLeftFootToLeft()
                : null
            }
            onSwipeRight={() =>
              startGame && !correlacionTresForGame
                ? onSwipeLeftFootToRight()
                : startGame && correlacionTresForGame && leftGame
                ? onSwipeLeftFootToRight()
                : null
            }
          ...
          <RightFoot
            onSwipeLeft={() =>
              startGame && !correlacionTresForGame
                ? onSwipeRightFootToLeft()
                : startGame && correlacionTresForGame && rightGame
                ? onSwipeRightFootToLeft()
                : null
            }
            onSwipeRight={() =>
              startGame && !correlacionTresForGame
                ? onSwipeRightFootToRight()
                : startGame && correlacionTresForGame && rightGame
                ? onSwipeRightFootToLeft()
                : null
            }
